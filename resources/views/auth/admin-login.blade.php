...
<form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
    ...
    <div class="flex items-center justify-between text-xs text-slate-500">
        ...
        <a href="{{ route('home') }}" class="text-emerald-600">Kembali ke beranda</a>
    </div>
    <button class="w-full rounded-xl bg-emerald-600 px-4 py-3 text-sm font-semibold text-white hover:bg-emerald-700">Masuk Admin</button>
</form>
@endsection
